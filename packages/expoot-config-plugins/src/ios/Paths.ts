...
export function getPodfilePath(
  projectRoot: string,
  platform: ModPlatform
): string {
  const [using, ...extra] = withSortedGlobResult(
...
export function findSchemePaths(
  projectRoot: string,
  platform: ModPlatform
): string[] {
...
export function findSchemeNames(
  projectRoot: string,
  platform: ModPlatform
): string[] {
 ...
 */
export function getXcodeProjectPath(
  projectRoot: string,
  platform: ModPlatform
): string {
...
export function getSupportingPath(
  projectRoot: string,
  platform: ModPlatform
): string {
  return path.resolve(
...
export function getExpoPlistPath(
  projectRoot: string,
  platform: ModPlatform
): string {
